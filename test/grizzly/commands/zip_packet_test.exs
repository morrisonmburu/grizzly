defmodule Grizzly.Commands.ZIPPacketTest do
  use ExUnit.Case
  ...
  test "an ack request requires a command, and can parse the command" do
    expected_command = %SwitchBinarySet{target_value: :off}
    binary = <<0x23, 0x02, 0x80, 0x50, 0x25, 0x00, 0x00, 0x00, 0x25, 0x01, 0x00>>
